...
sed -i "s/<a.*>fat<\/a>/<a href=\"https://oss.sonatype.org\/service\/local\/repositories\/releases\/content\/com\/amihaiemil\/web\/mention-notifications-ejb\/${tag}\/mention-notifications-ejb-${tag}-jar-with-dependencies\.jar\">fat<\/a>/" README.md
